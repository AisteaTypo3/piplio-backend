        ...
        'color_key' => [
            ...
            'config' => [
                ...
                'items'      => [
                    ...
                    ['label' => 'times6_7_8_9', 'value' => 'times6_7_8_9'],
                    ['label' => 'times_mixed', 'value' => 'times_mixed'],
                    ['label' => 'division_intro', 'value' => 'division_intro'],
                    ['label' => 'wall_math', 'value' => 'wall_math'],
                    ['label' => 'clock', 'value' => 'clock'],
                    ['label' => 'money', 'value' => 'money'],
                    ['label' => 'laengen', 'value' => 'laengen'],
                    ['label' => 'umrechnen_laenge', 'value' => 'umrechnen_laenge'],
                    ['label' => 'umrechnen_gewicht', 'value' => 'umrechnen_gewicht'],
                    ['label' => 'umrechnen_volumen', 'value' => 'umrechnen_volumen'],
                    ['label' => 'numbers1000', 'value' => 'numbers1000'],
                    ['label' => 'addition1000', 'value' => 'addition1000'],
                    ['label' => 'subtraction1000', 'value' => 'subtraction1000'],
                    ['label' => 'runden', 'value' => 'runden'],
                    ...
                    ['label' => 'deutsch_zeitformen', 'value' => 'deutsch_zeitformen'],
                    ['label' => 'deutsch_rechtschreibung', 'value' => 'deutsch_rechtschreibung'],
                    ['label' => 'deutsch_silben', 'value' => 'deutsch_silben'],
                    ['label' => 'deutsch_satzzeichen', 'value' => 'deutsch_satzzeichen'],
                ],
                'required' => true,
            ],
        ],
